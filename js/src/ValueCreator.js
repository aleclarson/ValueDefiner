...
(function() {
  var NamedFunction, ValueCreator, Void, assertReturnType, assertType, combine, emptyFunction, isType, ref, setKind, setType, steal, validateTypes;

  ref = require("type-utils"), Void = ref.Void, isType = ref.isType, setType = ref.setType, setKind = ref.setKind, assertType = ref.assertType, validateTypes = ref.validateTypes, assertReturnType = ref.assertReturnType;
